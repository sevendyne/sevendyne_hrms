...
# Client changed to project
class Client(BaseModel):   
    company = models.ForeignKey("main.Company",on_delete=models.CASCADE,limit_choices_to={'is_deleted': False})
    firstname = models.CharField(_('Contact Person Firstname'),max_length=255)
    lastname = models.CharField(_('Contact Person Lastname'),max_length=125,null=True,blank=True)
    email = models.EmailField(_("Email"),unique=True,null=True,blank=True)
    phone = models.CharField(_("Phone Number"),max_length=255,null=True,blank=True)
    address = models.TextField(_("Address"),null=True, blank=True)
    company_name = models.CharField(_('Client Company Name'),max_length=255,null=True,blank=True) #client company foreign key
