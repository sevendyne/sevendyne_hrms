...
class CompanyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            # 'state' :  autocomplete.ModelSelect2(url='main:state_autocomplete',forward=['country'],attrs={'data-minimum-input-length': 1,'data-placeholder':"State",'class': 'required form-control'},),
