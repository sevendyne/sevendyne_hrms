...
from apps.employee.tasks import send_employee_credentials_email_notification, send_leave_email_notification
from apps.main.decorators import company_required
from django.template.loader import render_to_string
from django.contrib.auth.hashers import make_password
from django.shortcuts import get_object_or_404, redirect, render
from django.contrib.auth.decorators import login_required, user_passes_test
from apps.main.functions import generate_form_errors, get_a_id, get_auto_id, get_current_company, has_admin_dashboard_permission, has_employee_dashboard_permission, has_hrms_permission
from apps.employee.forms import AdminHolidayForm, AttendanceDateForm, AttendanceRegisterForm, DepartmentForm, DesignationForm, EmployeeForm, EmployeeProfileForm, HolidayForm, LeaveForm, LeaveTypeForm
from apps.employee.models import GENDER_CHOICES, AdminHoliday, AttendanceRegister, Department, Designation, Employee, Holiday, Leave, LeaveType
from django.contrib.auth.models import User, Group
from django.core.paginator import Paginator
from django.core.mail import EmailMessage
from django.utils import timezone
from django.http import HttpResponse
from apps.payroll.models import Salary, SalaryDynamicField
